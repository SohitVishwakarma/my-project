    ...
    <div>
      ...
      <main className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex justify-center items-center p-6 md:block hidden">
            {/* Centered button container */}
            <button
              onClick={handleAddQuestion}
              className="flex items-center px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 hover:text-white focus:outline-none focus:bg-blue-600 focus:text-white transition duration-300"
            >
              {/* Larger button */}
              <FiPlus className="mr-3 text-2xl" /> Ask Question
            </button>
          </div>
        </div>
      </main>
